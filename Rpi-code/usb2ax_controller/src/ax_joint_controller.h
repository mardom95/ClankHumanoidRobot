...
#include "usb2ax_controller/ReceiveFromXL.h"
#include "usb2ax_controller/SendToXL.h"
...
public:
    ...
    //
    bool sendToXL(usb2ax_controller::SendToXL::Request &req,
					   usb2ax_controller::SendToXL::Response &res);
    bool receiveFromXL(usb2ax_controller::ReceiveFromXL::Request &req,
...
private:
    ...
    int deviceIndex;
    int baudNum;
    int numOfAXconnectedMotors;
    int numOfXLconnectedMotors;
    std::vector<bool> connectedAXMotors;
    std::vector<bool> connectedXLMotors;
